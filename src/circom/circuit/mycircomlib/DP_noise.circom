...
/*
{
  "in_hash": "4343698204186575808494600",
  "sig_acc": 100,
  "in_Rand_X": [100000,30627,92744,52843,47617,17860,61500,65160,78716,17484,89905,86510,4464,98978,8469,96320,26654,52436,31687,48213,100000,30627,92744,52843,47617,17860,61500,65160,78716,17484,89905,86510,4464,98978,8469,96320,26654,52436,31687,48213,100000,30627,92744,52843,47617,17860,61500,65160,78716,1,89905,86510,4464,98978,8469,96320,26654,52436,31687,48213,100000,30627,92744,52843,47617,17860,61500,65160,78716,17484,89905,86510,4464,98978,8469,96320,26654,52436,31687,48213,100000,30627,92744,52843,47617,17860,61500,65160,78716,17484,89905,86510,4464,98978,8469,96320,26654,52436,31687]
}
*/
...
template DP_GetRandomVar(k, var_acc) {
    ...
    for (var j = 0; j < k; j++) {
        ...
        getP[j] <== tmp_getP[j] + comp_getP[j].out;
    }
...
//component main = DP_GetRandomVar(4, 100);
