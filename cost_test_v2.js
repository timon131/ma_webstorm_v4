const cost_calc = require('./cost_experimental_v2');
...
async function exec(number_of_tests, n_client) {
    ...
    for (let i = 0; i < number_of_tests; i++) {
        test = await cost_calc.exec(5, 1000, 100, n_client, 1, 100);

        //cost
        cost[0][i] = test[0][0];    //benchmark
        cost[1][i] = test[0][1];    //private
        cost[2][i] = test[0][2];    //LOOsmall_test
        cost[3][i] = test[0][3];    //LOOlarge
        cost[4][i] = test[0][4];    //central
        cost[5][i] = test[0][5];    //random

        //Euclidean distances
        EuDist[0][i] = test[1][0];  //private
        EuDist[1][i] = test[1][1];  //LOOsmall_test
        EuDist[2][i] = test[1][2];  //LOOlarge
        EuDist[3][i] = test[1][3];  //central
        EuDist[4][i] = test[1][4];  //random

        //correlation
        corr[0][i] = test[2][0];    //private
        corr[1][i] = test[2][1];    //LOOsmall_test
        corr[2][i] = test[2][2];    //LOOlarge
        corr[3][i] = test[2][3];    //central
    ...
    let CostDiff_benchmark_central = [];
    ...
    for (let l = 0; l < n_client; l++) {
        ...
        CostDiff_benchmark_central[l] = [];
        CostDiff_benchmark_random[l] = [];
        for (let i = 0; i < number_of_tests; i++) {
            CostDiff_benchmark_private[l][i] = cost[1][i][l] - cost[0][i][l];
            CostDiff_benchmark_LOOsmall_test[l][i] = cost[2][i][l] - cost[0][i][l];
            CostDiff_benchmark_LOOlarge[l][i] = cost[3][i][l] - cost[0][i][l];
            CostDiff_benchmark_central[l][i] = cost[4][i][l] - cost[0][i][l];
    ...
    let CostDiff_median_benchmark_central = [];
    ...
    let CostDiff_var_benchmark_central = [];
    ...
    for (let l = 0; l < n_client; l++) {
        ...
        CostDiff_median_benchmark_central[l] = matrixmath.median(CostDiff_benchmark_central[l]);
        ...
        CostDiff_var_benchmark_central[l] = matrixmath.variance(CostDiff_benchmark_central[l], 'uncorrected');
    ...
    let EuDist_mean_benchmark_LOOsmall_test = matrixmath.mean(EuDist[1]);
    let EuDist_mean_benchmark_LOOlarge = matrixmath.mean(EuDist[2]);
    let EuDist_mean_benchmark_central = matrixmath.mean(EuDist[3]);
    ...
    let EuDist_var_benchmark_LOOsmall_test = matrixmath.variance(EuDist[1], 'uncorrected');
    let EuDist_var_benchmark_LOOlarge = matrixmath.variance(EuDist[2], 'uncorrected');
    let EuDist_var_benchmark_central = matrixmath.variance(EuDist[3], 'uncorrected');
    ...
    let corr_mean_benchmark_LOOsmall_test = matrixmath.mean(corr[1]);
    let corr_mean_benchmark_LOOlarge = matrixmath.mean(corr[2]);
    let corr_mean_benchmark_central = matrixmath.mean(corr[3]);
    ...
    let corr_var_benchmark_LOOsmall_test = matrixmath.variance(corr[1], 'uncorrected');
    let corr_var_benchmark_LOOlarge = matrixmath.variance(corr[2], 'uncorrected');
    let corr_var_benchmark_central = matrixmath.variance(corr[3], 'uncorrected');
    ...
    console.log('EuDist_benchmark-central:');
    console.log('mean: ' + EuDist_mean_benchmark_central);
    console.log('var: ' + EuDist_var_benchmark_central);
    ...
    console.log('Corr_benchmark-central:');
    console.log('mean: ' + corr_mean_benchmark_central);
    console.log('var: ' + corr_var_benchmark_central);
    ...
    let CostDiff_data = [
        ...
        {y: CostDiff_median_benchmark_central, type: 'line', name: 'median: benchmark <> central'},
        ...
        {y: CostDiff_var_benchmark_central, type: 'line', name: 'variance: benchmark <> central'},
    ...
    let EuDist_data = [
        ...
        {y: EuDist[1], type: 'line', name: 'benchmark <> LOOsmall_test'},
        {y: EuDist[2], type: 'line', name: 'benchmark <> LOOlarge'},
        {y: EuDist[3], type: 'line', name: 'benchmark <> central'},
    ...
    let Corr_data = [
        ...
        {y: corr[1], type: 'line', name: 'benchmark <> LOOsmall_test'},
        {y: corr[2], type: 'line', name: 'benchmark <> LOOlarge'},
        {y: corr[3], type: 'line', name: 'benchmark <> central'},
        {y: corr[4], type: 'line', name: 'benchmark <> random'}
    ];

    let Corr_data_hist = [
        {x: corr[3], type: 'histogram', name: 'benchmark <> central'}
    ]
    ...
    let Corr_layout_hist = {
        title: 'Overview of cost approaches: Correlation central',
        xaxis: {
            title: 'correlation',
            showgrid: false,
            zeroline: false,
